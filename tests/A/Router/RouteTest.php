...
class RouteTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp() 
    {
        ...
        $this->_routeEndStat = new \A\Router\Route(array(
                                                        'name' => $this->_name . 5,
                                                        'route' => $this->_routeEndStatRegexp,
                                                     ));

        $this->_routeDefault = new \A\Router\Route(array(
                                                          'name' => 'default',
                                                          'route' => 'default/*'
                                                     ));
    }
    ...
    {
        $this->assertInstanceOf('\A\Router\Route', $this->_route);
    }
